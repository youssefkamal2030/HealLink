      ...
      GuardianId: patient?.GuardianId
            ...
            if (doctor != null)
            {
                ...
                var doctorProfile = new DoctorProfileResponse(
                    ...
                    Email: user.Email,
                    Gender: doctor.PersonalInfo?.Gender ?? string.Empty,
nationality: doctor.PersonalInfo?.Nationality ?? string.Empty,
                    city: doctor.Address?.City ?? string.Empty,
                    country: doctor.Address?.Country ?? string.Empty,
                    Specialization: doctor.Specialization,
                    CurrentWorkplace: doctor.CurrentWorkplace?? string.Empty,
