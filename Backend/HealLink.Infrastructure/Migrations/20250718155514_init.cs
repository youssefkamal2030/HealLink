        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyndicateIdImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PracticeLicenseNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NationalID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsAvailableForChat = table.Column<bool>(type: "bit", nullable: false),
                    QRCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QRCodeGeneratedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadedByGuardianId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestResults_Guardians_UploadedByGuardianId",
                        column: x => x.UploadedByGuardianId,
                        principalTable: "Guardians",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestResults_UploadedByGuardianId",
                table: "TestResults",
                column: "UploadedByGuardianId");
        }
