...
class S {
  ...
  /// `Cardiac Enzymes`
  String get cardiac_enzymes {
    return Intl.message(
      'Cardiac Enzymes',
      name: 'cardiac_enzymes',
      desc: '',
      args: [],
    );
  }
  ...
  String get chest_xray {
    return Intl.message('Chest X-ray', name: 'chest_xray', desc: '', args: []);
  }

  /// `CT Coronary Angiography`
  String get ct_coronary_angiography {
    return Intl.message(
      'CT Coronary Angiography',
      name: 'ct_coronary_angiography',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Cardiac MRI`
  String get cardiac_mri {
    return Intl.message('Cardiac MRI', name: 'cardiac_mri', desc: '', args: []);
  }
